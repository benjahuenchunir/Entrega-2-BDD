...
class Paths(Enum):
    PATH_PROOVEDORES = f'{FOLDER_DATOS}proveedores.csv'
...
class PathsClean(Enum):
    PATH_PROOVEDORES = 'proveedores.csv'
    ...
    PATH_PELICULAS_PROOVEDORES = 'proovedores_peliculas.csv'
    PATH_SERIES_PROOVEDORES = 'proovedores_series.csv'
